...
emptyStateElement.classList.add("roster-empty-state");
emptyStateElement.innerHTML = `   <svg viewBox="0 0 400 250" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
